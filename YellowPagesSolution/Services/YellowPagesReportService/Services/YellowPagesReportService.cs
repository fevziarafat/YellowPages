...
using LocationInformation = YellowPagesReportService.Models.LocationInformation;
using Models_YellowPages = YellowPagesReportService.Models.YellowPages;
using PhoneInformation = YellowPagesReportService.Models.PhoneInformation;
using YellowPagesReport = YellowPagesReportService.Models.YellowPagesReport;
using YellowPagesReportCreateDto = YellowPagesReportService.Dtos.YellowPagesReportCreateDto;
using YellowPagesReportDto = YellowPagesReportService.Dtos.YellowPagesReportDto;
