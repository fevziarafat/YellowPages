...
using EMailInformation = YellowPagesService.Models.EMailInformation;
...
using LocationInformation = YellowPagesService.Models.LocationInformation;
using Models_YellowPages = YellowPagesService.Models.YellowPages;
using PhoneInformation = YellowPagesService.Models.PhoneInformation;
using YellowPagesCreateDto = YellowPagesService.Dtos.YellowPagesCreateDto;
using YellowPagesDto = YellowPagesService.Dtos.YellowPagesDto;
